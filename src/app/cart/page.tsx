                                    ...
                                    <div className="sm:ml-4 sm:flex sm:w-full sm:justify-between">
                                        ...
                                        <div className="mt-4 flex justify-between sm:space-y-6 sm:mt-0 sm:block sm:space-x-6">
                                            <div className="flex items-center border-gray-100">
                                                <span className="cursor-pointer rounded-l bg-gray-100 py-1 px-3.5 text-xl duration-100 hover:bg-blue-500 hover:text-blue-50" onClick={() => updateQuantity(item.id?.toString() || '', item.quantity - 1)}> - </span>
                                                <span className="bg-gray-100 px-4 text-xl py-1">{item.quantity}</span>
                                                <span className="cursor-pointer rounded-r bg-gray-100 text-xl py-1 px-3 duration-100 hover:bg-blue-500 hover:text-blue-50" onClick={() => updateQuantity(item.id?.toString() || '', item.quantity + 1)}> + </span>
