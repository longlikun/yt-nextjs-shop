  ...
  return (
    ...
    <div className="mx-auto max-w-screen-xl px-4 sm:px-6 lg:px-8">
        <div className="flex h-16 items-center justify-between">
            ...
            <div className="flex-1 md:flex md:items-center md:gap-12">
                ...
                <nav aria-label="Global" className="hidden ml-10 md:block ">
                    <ul className="flex items-center gap-8 text-md  font-bold ">
                        ...
                        <li>
                            <a className="text-gray-500 transition hover:text-gray-500/75" href="#"> 衣服 </a>
                        </li>

                        <li>
                            <a className="text-gray-500 transition hover:text-gray-500/75" href="#"> 配饰 </a>
                        </li>
            ...
            {/* 搜索框 */}
            <div className="relative w-1/4 mr-8">
                ...
                <input
                    ...
                    id="Search"
                    placeholder="搜索..."
                    className="w-full  pl-4 rounded-md border-gray-200 py-2.5 pe-10 shadow-sm sm:text-sm"
                />
...
{/* 购物车 */}
                ...
                <div className="hidden relative md:block">
                    ...
                    >
                        ...
                        <span className="absolute -bottom-0 -left-0.5 rounded-full bg-neutral-900 p-0.25 px-1 text-xs  text-red-50">1</span>
                    </button>
